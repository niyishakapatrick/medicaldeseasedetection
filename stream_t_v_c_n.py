...
def main():
    ...
    st.markdown("<small style='color: black;'>Keeza ~ Tech | +250788384528,+250788317992,+250785540835 | keey08@gmail.com |Noorsken - Kigali - Rwanda</small>", unsafe_allow_html=True)
